...
import { buildReadRequestOptions, parseJSONResponse } from "../lib/dashboardApi";
import {
  DASHBOARD_DEVICE_ID,
...
import { normalizeReadings } from "../lib/readings";
...
export function useReadingsHistoryWindows({
  backendBaseUrl,
  historyCacheRef,
