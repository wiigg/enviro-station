...
export const INSIGHT_POLL_INTERVAL_MS = MINUTE_MS;
export const INSIGHT_MAX_ITEMS = 3;
export const INSIGHT_DIAGNOSTIC_STALE_AFTER_MS = 2 * HOUR_MS;
...
export const CONNECTION_STATUS_CHECK_INTERVAL_MS = 5 * 1000;
